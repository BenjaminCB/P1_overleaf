...
The data is a spreadsheet that comes in directly from the Human Resources department of \siemens. The spreadsheet has the same layout as seen in Table \ref{tab:exampleSchedule} which can be found on page \pageref{tab:exampleSchedule}. Additionally the spreadsheet comes with small inputs like expected work hours and amount of holidays, which helps the worker fixing the schedule, so they easily can reference different numbers like maximum hours per week.
